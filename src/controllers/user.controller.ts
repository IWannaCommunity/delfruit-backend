...
import { type StdLogger, getLoggerFromRequest } from "../logger";
...
import type { User as UserEntity } from "../model/entity/user";
import type { GetUsersParams, PatchUserParams } from "../model/params/user";
...
export class UserController extends Controller {
    ...
    public async getUsers(
        ...
        >
    > {
        const LOG: StdLogger = getLoggerFromRequest(req);
        ...
        try {
            ...
            LOG.warn("user provided authorization, but it was invalid.");
            //this.setStatus(401);
    ...
    public async patchUser(
        ...
        const user: UserEntity = requestBody as unknown as any;
        user.id = id;

...
import { createUser, createGame, addScreenshot, hasPermission, expectToContainAllKeys } from "./testing-utilities";
...
describe("screenshot endpoint", () => {
    ...
    test("prevents anons from creating a screenshot", async () => {
        ...
        try {
            await axios.post(`http://localhost:4201/games/${game.id}/screenshots`, data, {
